This script based on the Ultimate Fuel Script v2.1.0.0 source by Pedro Rodrigues
...
v1.7.1.7 BETA, XLiveLess ASI loader (for ScriptHook) and this script developed
